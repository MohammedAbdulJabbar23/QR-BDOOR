...
namespace AlBadour.Infrastructure.Persistence.Migrations
{
    ...
    [Migration("20260328062409_AllowReuseDocNumberOnRevokeOrDelete")]
    partial class AllowReuseDocNumberOnRevokeOrDelete
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("AlBadour.Domain.Entities.IssuedDocument", b =>
                {
                    ...
                    b.Property<string>("AccountStatementPath")
                        .HasMaxLength(500)
                        .HasColumnType("character varying(500)")
                        .HasColumnName("account_statement_path");
                    ...
                    b.Property<string>("LeaveGranted")
                        .HasMaxLength(500)
                        .HasColumnType("character varying(500)")
                        .HasColumnName("leave_granted");

                    b.Property<DateTime?>("MedicalReportUploadedAt")
                        .HasColumnType("timestamp with time zone")
                        .HasColumnName("medical_report_uploaded_at");
                    ...
                    b.Property<string>("PatientProfession")
                        .HasMaxLength(200)
                        .HasColumnType("character varying(200)")
                        .HasColumnName("patient_profession");
                    ...
                    b.HasIndex("DocumentNumber")
                        .IsUnique()
                        .HasFilter("is_deleted = FALSE AND status != 'revoked'");
